...
abstract class BuildableType_Builder {
  ...
  private static final class Value extends BuildableType {
    ...
    public int hashCode() {
      return Arrays.hashCode(
          new Object[] {type, builderType, mergeBuilder, partialToBuilder, builderFactory});
    }
  ...
  private static final class Partial extends BuildableType {
    ...
    public int hashCode() {
      return Arrays.hashCode(
          new Object[] {
            type, builderType, mergeBuilder, partialToBuilder, builderFactory, _unsetProperties
          });
    }
